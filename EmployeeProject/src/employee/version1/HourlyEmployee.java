...
public class HourlyEmployee {
	    ...
	    public double ComputeSal() {
	            ...
	            if(this.totalHoursWorked > 40) {
	                Value = (40 * this.ratePerHour) + ((this.totalHoursWorked - 40)*(this.ratePerHour + (this.ratePerHour * 0.50)));
	            }
	            else {
	                Value = this.totalHoursWorked * this.ratePerHour;
	            }
	    ...
	    public void displayInfo() {
	        System.out.printf("Hours worked for this week: %.2f\nRate per hour: Php %.2f \nTotal income for the week: Php %.2f",totalHoursWorked,ratePerHour,Value);
	    }
